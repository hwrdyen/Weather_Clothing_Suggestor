...
//background images
import main_image from "../../assets/backgroundimages/mainimage.png";
...
import mainoutfitpage from "../../assets/outfit/mainIMG.png";
...
import women_Warmnorain from "../../assets/outfit/mexicocity.png";
...
function WeatherForm() {
	...
	const [outfitimg, setoutfitimg] = useState(mainoutfitpage);
			...
			<div className="output_div">
				...
				<div className="temperature_block">
					<p className="output_temp">
						Temperature: {apiData.current?.temp_c} celcius
					</p>
				</div>
